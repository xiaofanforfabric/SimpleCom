...
public class ChannelScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(new ButtonWidget(centerX - 105, height / 2 + 40, 100, 20, new LiteralText(BTN_CREATE_ENCRYPTED), b -> {
            if (client != null) client.setScreen(new CreateEncryptedChannelScreen(parent));
        }));
        addDrawableChild(new ButtonWidget(centerX + 5, height / 2 + 40, 100, 20, new LiteralText(BTN_CONNECT_ENCRYPTED), b -> {
