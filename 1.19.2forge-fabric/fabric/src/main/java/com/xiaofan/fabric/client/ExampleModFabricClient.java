...
public final class ExampleModFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
            ...
            try {
                ...
                client.execute(() -> {
                    ...
                    if (client.player != null) {
                        client.player.sendMessage(Text.literal(SimpleComVoiceClient.getConnectSuccessMessage(data.serverType)), false);
                        client.player.sendMessage(Text.literal(SimpleComVoiceClient.getCompressionStatusMessage(data.useCompressionEncoder)), false);
                        client.player.sendMessage(Text.literal(SimpleComVoiceClient.getLowLatencyStatusMessage(data.lowLatency)), false);
        ...
        ClientPlayNetworking.registerGlobalReceiver(HandshakePayloadAdapter.CHANNEL_SWITCH_ACK_CHANNEL, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                if (client.player != null) {
                    client.player.sendMessage(Text.literal("信道已成功切换到" + finalCh), false);
                }
            });
        });
